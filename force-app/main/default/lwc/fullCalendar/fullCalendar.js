...
export default class Calender extends LightningElement {
  ...
  renderedCallback() {
    ...
    // Initialize disabled dates before calendar initialization
    this.disabledDates = [
  ...
  initializeFlatpickr() {
    ...
    this.startDatePicker = flatpickr(startInput, {
        ...
        disable: [disableWeekends, ...this.disabledDates]
    });
  ...
  initialiseCalendarJs() { 
    ...
    $(ele).fullCalendar({
      ...
      selectAllow: function(selectInfo) {
        ...
        var dateStr = selectInfo.start.format('YYYY-MM-DD');
        ...
        // Block disabled dates (holidays)
        if (that.disabledDates && that.disabledDates.includes(dateStr)) {
          return false;
        }
      ...
      dayRender: function(date, cell) {
        ...
        // Style weekends (Saturday = 6, Sunday = 0)
